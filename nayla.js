...
{"urlButton": {"displayText": "▸ɪɴꜱᴛᴀɢʀᴀᴍ◂","url": "https://www.instagram.com/irfanmlna13_/?hl=id"}},
...
const reply = (teksnya) => {
const nyz1 = [{index: 1, urlButton: {displayText: 'ᴄʀᴇᴀᴛᴇᴅ ʙʏ ɪʀꜰᴀɴᴍʟɴᴀ', url: 'https://wa.me/' + nomerowner}}]
...
{title: `SENDOK (${myHadiah(sender, "sendok")})`, rowId: "Irfanmlna13_", description: "HARGA : 13.000"},
{title: `SANDAL (${myHadiah(sender, "sandal")})`, rowId: "Irfanmlna13_", description: "HARGA : 20.000"},
{title: `MINYAK (${myHadiah(sender, "minyak")})`, rowId: "Irfanmlna13_", description: "HARGA : 30.000"},
{title: `IKAN (${myHadiah(sender, "ikan")})`, rowId: "Irfanmlna13_", description: "HARGA : 50.000"},
{title: `PANCI (${myHadiah(sender, "panci")})`, rowId: "Irfanmlna13_", description: "HARGA : 75.000"},
{title: `MOBIL (${myHadiah(sender, "mobil")})`, rowId: "Irfanmlna13_", description: "HARGA : 100.000"}]}]
...
await sendMenu(from, menuu, "ʟᴜʟᴀʙᴏᴛ - ᴄʀᴇᴀᴛᴇᴅ ʙʏ ɪʀꜰᴀɴᴍʟɴᴀ13", await nayla.sendnew(from, {image : {url:`./media/image/menu/${gg}.jpg` }, caption: menuu}),{quoted:nay1})
break
case 's':
case 'sticker':
case 'stiker':
